...
export function _ZN12wasm_bindgen7convert8closures11invoke1_mut17hc7476fbbe91b1a71E(a: number, b: number, c: number): void;
export function _ZN129__LT_dyn_u20_core__ops__function__Fn_LT__LP__RP__GT__u2b_Output_u20__u3d__u20_R_u20_as_u20_wasm_bindgen__closure__WasmClosure_GT_8describe6invoke17h1ee645393cbbc66bE(a: number, b: number): number;
export function _ZN12wasm_bindgen7convert8closures7invoke117hc1f5a28260db64ceE(a: number, b: number, c: number): number;
export function __wbindgen_exn_store(a: number): void;
export function _ZN12wasm_bindgen7convert8closures11invoke2_mut17h0fc301775c78d729E(a: number, b: number, c: number, d: number): void;
