...
*/
  static deployApp(appConfig: any): Promise<DeployedApp>;
/**
* Create a `WasmerPackage`.
* @param {object} manifest
* @returns {Promise<Wasmer>}
*/
  static createPackage(manifest: object): Promise<Wasmer>;
/**
...
interface InitOutput {
  ...
  readonly _ZN12wasm_bindgen7convert8closures11invoke1_mut17hc7476fbbe91b1a71E: (a: number, b: number, c: number) => void;
  readonly _ZN129__LT_dyn_u20_core__ops__function__Fn_LT__LP__RP__GT__u2b_Output_u20__u3d__u20_R_u20_as_u20_wasm_bindgen__closure__WasmClosure_GT_8describe6invoke17h1ee645393cbbc66bE: (a: number, b: number) => number;
  readonly _ZN12wasm_bindgen7convert8closures7invoke117hc1f5a28260db64ceE: (a: number, b: number, c: number) => number;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly _ZN12wasm_bindgen7convert8closures11invoke2_mut17h0fc301775c78d729E: (a: number, b: number, c: number, d: number) => void;
...
export { Atom, Command, DeployedApp, type DirEntry, Directory, type DirectoryInit, type InitInput, type InitOutput, Instance, IntoUnderlyingByteSource, IntoUnderlyingSink, IntoUnderlyingSource, type Output, PublishPackageOutput, type RunOptions, Runtime, type RuntimeOptions, type SpawnOptions, type SyncInitInput, UserPackageDefinition, Volume, Wasmer, WasmerPackage, __wbg_init as default, initSync, initializeLogger, runWasix, setWorkerUrl, wat2wasm };
